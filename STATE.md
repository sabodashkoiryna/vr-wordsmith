...
- Етап 6 (кабінет: `/learn`, плеєр уроку, теми читання) і етап 7 (`QuizRunner`)
  — **написані й задеплоєні, але жодного разу не перевірені живими**: база
  порожня, сід не запускався. Це перше, що треба зробити.
