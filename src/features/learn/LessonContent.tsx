    ...
    <div className="prose">
      <Markdown
        ...
        components={{
          ...
          // Прокрутку вішаємо на обгортку, а не на саму таблицю. З
          // `display:block` на <table> вона перестає розтягуватись на всю
          // ширину: фон рядка заголовків і зебра обриваються там, де
          // закінчується найдовша комірка, і рамка лишається напівпорожньою.
          table: ({ children }) => (
